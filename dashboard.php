...
<?php
 ...
 $cs2=$_SESSION['cs1'] ;
  ...
  $tl=0;
    ...
    $tcalb=0;
	$z=0;
	$sql= "Select * from records where  username ='$u'" ;
...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    url: "http://localhost/hackethon/data2.php",
    method: "GET",
...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    url: "http://localhost/hackethon/data1.php",
    method: "GET",
...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    url: "http://localhost/hackethon/data.php",
    method: "GET",
    success: function(data) {
...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    url: "http://localhost/hackethon/data3.php",
    method: "GET",
    success: function(data) {
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-green">
                <div class="inner">
                  <h3><?php if($z==0) { echo 0; } else {$acalb=($tcalb/$z); echo number_format((float)$acalb, 2, '.', '');} ?></h3>
                  <p>Average Calories Burned </p>
                </div>
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-red">
                <div class="inner">
                  <h3><?php if($y==0){ echo 0; } else { echo number_format((float)($tl/$y), 2, '.', ''); }?></h3>
                  <p>Average Load</p>
                </div>
                <div class="icon">
                ...
                <ul class="nav nav-tabs pull-right">
                  ...
                  <li><a href="#mycanvas1" data-toggle="tab">Year</a></li>
                   <li><a href="#mycanvas2" data-toggle="tab">Date</a></li>
				    <li><a href="#mycanvas3" data-toggle="tab">Type</a></li>
                  <li class="pull-left header"><i class="fa fa-inbox"></i> History</li>
                </ul>
                <div class="tab-content no-padding">
                  <!-- Morris chart - Sales -->
                  <canvas class="chart tab-pane active" id="mycanvas" style="position: relative; "> </canvas>
                 ...
                 <canvas class="chart tab-pane" id="mycanvas3" style="position: relative; height:300px;"></canvas>
			   </div>
              </div><!-- /.nav-tabs-custom -->
