...
<?php
 ...
 $cs2=$_SESSION['cs1'] ;
  ...
  $tl=0;
    ...
    $tcalb=0;
	$z=0;
	$sql= "Select * from records where trainingt='Swimming' AND username ='$u'" ;
...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    url: "http://localhost/hackethon/datas2.php",
    method: "GET",
...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    url: "http://localhost/hackethon/datas1.php",
    method: "GET",
...
$(document).ready(function(){
  ...
  $.ajax({
    ...
    url: "http://localhost/hackethon/datas.php",
    method: "GET",
    success: function(data) {
